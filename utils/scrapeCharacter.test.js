...
describe('scrapeCharacterData', () => {
  it('should parse Agent S', () => {
    return request.get('https://animalcrossing.fandom.com/wiki/Agent_S')
      .then(({ text }) => {
        return scrapeCharacterData(text)
          .then(character => {
  ...
  it('should parse Canberra', () => {
    return request.get('https://animalcrossing.fandom.com/wiki/Canberra')
      .then(({ text })=> {
        return scrapeCharacterData(text)
          .then(character => {
            expect(character).toEqual({
  ...
  it('should parse Admiral', () => {
    return request.get('https://animalcrossing.fandom.com/wiki/Admiral')
      .then(({ text }) => {
        return scrapeCharacterData(text)
          .then(character => {
            expect(character).toEqual({
